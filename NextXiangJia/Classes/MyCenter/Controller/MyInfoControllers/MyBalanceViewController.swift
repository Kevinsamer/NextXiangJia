...
extension MyBalanceViewController {
    private func setUI(){
        ...
        YTools.setNavigationBarAndTabBar(navCT: self.navigationController!, tabbarCT: self.tabBarController!, titleName: "账户余额", navItem:self.navigationItem)
        //2.设置bodyContent
        setupBodyContent()
    }
