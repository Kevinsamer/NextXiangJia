            ...
            <<< ButtonRow("saveButton"){
                $0.title = "保存"
                    ...
                    if errors.count != 0 {
                        ...
                        self.myCenterViewModel.requestEditAddress(id:id!, acceptName: accept_name, province: province!, city: city!, area: area!, address: address, zip: zip, telphone: telphone, mobile: mobile, finishCallback: { msg in
                            if msg == ""{
                                //添加成功
